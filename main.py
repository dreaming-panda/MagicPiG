...
def setup_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        type=float,
        default=1.1,
        help="Top-P of sparse attention ",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=64,
        help="Top-K of sparse attention ",
    )
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.25,
        help="Sparse Ratio of sparse attention ",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=8,
        help="#Sink Tokens of sparse attention ",
    )
    parser.add_argument(
        "--local",
        type=int,
        default=256,
        help="#Local Tokens of sparse attention ",
    )
