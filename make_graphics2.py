...
for m_s in product(model, sparse):
    ...
    if VALID_NUMBER > 0:
        ...
        plt.plot(random_sparse[:VALID_NUMBER], RESULTS[1][:VALID_NUMBER], c="green", label="anns-es")
